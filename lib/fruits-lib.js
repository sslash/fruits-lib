...
/***/ function(module, exports, __webpack_require__) {
	...
	var _middleware2 = __webpack_require__(88);
	
	var _middleware = _interopRequireWildcard(_middleware2);
	
	var _services2 = __webpack_require__(90);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dateformat = __webpack_require__(13);
	...
	var _humanizeDuration = __webpack_require__(14);
	...
	var Route = function (_RouteRecord) {
	    ...
	    _createClass(Route, [{
	        ...
	        value: function getKM() {
	            var nrOfDecimals = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
	        ...
	        value: function getDuration() {
	            var opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { spacer: ' ' };
	        ...
	        value: function updateVenueSocials(venueSocials) {
	        ...
	        value: function mapper() {
	            ...
	            var vertices = (0, _get2.default)(route, 'vertices', (0, _get2.default)(route, '_embedded.vertices', []));
	            var mappedRoute = new Route(route);
	
	            return mappedRoute.set('vertices', new _immutable.List(vertices.map(function (vert) {
	                return _Vertice2.default.mapper(vert);
	            }))).set('user', (0, _immutable.fromJS)(route.user || {})).set('buckets', new _immutable.List(route.buckets)).set('comments', new _immutable.List());
	        }
	    }, {
	        key: 'doUpdate',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Vertice = function (_VerticeRecord) {
	    ...
	    function Vertice() {
	        ...
	        return _possibleConstructorReturn(this, (Vertice.__proto__ || Object.getPrototypeOf(Vertice)).apply(this, arguments));
	    }
	...
	var Venue = function (_VenueRecord) {
	    ...
	    _createClass(Venue, [{
	        ...
	        value: function getOpeningsHours() {
	            var openingHours = this.get('venueSocial') && this.get('venueSocial').google_venue ? this.get('venueSocial').google_venue.opening_hours : this.get('openingHours');
	        ...
	        key: 'formatPrice',
	        value: function formatPrice(tier) {
	            tier = tier || 0;
	            var greyDollar = '$$$$';
	            var blackDollar = '';
	        ...
	        value: function getFoursquareImage(foursquareImage) {
	            var wantBig = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
	        ...
	        key: 'mapper',
	        value: function mapper() {
	            var venue = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
	
	            var created = new Venue(venue).set('buckets', new _immutable.List(venue.buckets || []));
	
	            // mapping from graphql venueCollection
	            if (venue.lat && venue.lng) {
	                created = created.set('geometry', (0, _immutable.fromJS)({
	                    lat: venue.lat,
	                    lng: venue.lng
	                }));
	                ...
	                created = created.set('geometry', (0, _immutable.fromJS)(venue.geometry));
	            }
	        ...
	        value: function foursquareToVenue(venue) {
	            var thumb = void 0;var photos = void 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _routesActions = __webpack_require__(28);
	
	var routes = _interopRequireWildcard(_routesActions);
	
	var _createVerticeAction = __webpack_require__(30);
	
	var createVertice = _interopRequireWildcard(_createVerticeAction);
	
	var _createRouteActions = __webpack_require__(31);
	
	var createRoute = _interopRequireWildcard(_createRouteActions);
	
	var _flashMessagesActions = __webpack_require__(36);
...
/***/ function(module, exports) {
	...
	var CITIES_QUERY_FETCH = exports.CITIES_QUERY_FETCH = 'CITIES_QUERY_FETCH';
	var CITIES_QUERY_FETCH_SUCCESS = exports.CITIES_QUERY_FETCH_SUCCESS = 'CITIES_QUERY_FETCH_SUCCESS';
	var CITIES_QUERY_FETCH_FAIL = exports.CITIES_QUERY_FETCH_FAIL = 'CITIES_QUERY_FETCH_FAIL';
	var CITIES_CLEAR = exports.CITIES_CLEAR = 'CITIES_CLEAR';
	var REVERSE_GEOCODING_FETCH = exports.REVERSE_GEOCODING_FETCH = 'REVERSE_GEOCODING_FETCH';
	var REVERSE_GEOCODING_FETCH_SUCCESS = exports.REVERSE_GEOCODING_FETCH_SUCCESS = 'REVERSE_GEOCODING_FETCH';
	var REVERSE_GEOCODING_FETCH_FAIL = exports.REVERSE_GEOCODING_FETCH_FAIL = 'REVERSE_GEOCODING_FETCH';
	...
	var USER_FORGOT_PASSWORD_FAIL = exports.USER_FORGOT_PASSWORD_FAIL = 'USER_FORGOT_PASSWORD_FAIL';
	...
	var INSTA_TOKEN_STORE = exports.INSTA_TOKEN_STORE = 'INSTA_TOKEN_STORE';
	...
	var SEARCH_CLEAR = exports.SEARCH_CLEAR = 'SEARCH_CLEAR';
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	function fetchCityBuckets(dispatch) {
	    var city = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'Oslo';
	    var resetRoutes = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
	...
	function queryRoutesNative(_ref5) {
	    var _ref5$selectedCity = _ref5.selectedCity,
	        selectedCity = _ref5$selectedCity === undefined ? '' : _ref5$selectedCity,
	        stateRoutes = _ref5.stateRoutes,
	        _ref5$searchTerm = _ref5.searchTerm,
	        searchTerm = _ref5$searchTerm === undefined ? '' : _ref5$searchTerm,
	        _ref5$sortName = _ref5.sortName,
	        sortName = _ref5$sortName === undefined ? _constants.POPULAR : _ref5$sortName,
	        _ref5$resetOffset = _ref5.resetOffset,
	        resetOffset = _ref5$resetOffset === undefined ? false : _ref5$resetOffset;
...
/***/ function(module, exports) {
	...
	var HAS_SEEN_FIRST_SAVE_SPOT = exports.HAS_SEEN_FIRST_SAVE_SPOT = 'HAS_SEEN_FIRST_SAVE_SPOT';
	var HAS_SEEN_FIRST_LIKE_ROUTE = exports.HAS_SEEN_FIRST_LIKE_ROUTE = 'HAS_SEEN_FIRST_LIKE_ROUTE';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GooglePlacesAPIClient = __webpack_require__(34);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reorderService = __webpack_require__(32);
	...
	var _pollSpices = __webpack_require__(33);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }
	
	var routeService = void 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.storeInstaAuthToken = storeInstaAuthToken;
	...
	function storeInstaAuthToken(instaAuthToken) {
	    return {
	        type: types.INSTA_TOKEN_STORE,
	        instaAuthToken: instaAuthToken
	    };
	}
	...
	function forgotPassword(mail) {
	    ...
	    return {
	        types: [types.USER_FORGOT_PASSWORD, types.USER_FORGOT_PASSWORD_SUCCESS, types.USER_FORGOT_PASSWORD_FAIL],
	        promise: function promise(_ref7) {
	            var req = _ref7.req;
	            return req.post('/users/forgotPassword', { mail: mail });
	        }
	    };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function bootstrapRoute(route) {
	    var mappedRoute = _immutable.Iterable.isIterable(route) ? route : _Route2.default.mapper(route);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.fetchCityAutocomplete = fetchCityAutocomplete;
	exports.clearCitySearch = clearCitySearch;
	...
	function fetchCityAutocomplete(cityQuery) {
	    return {
	        types: [actions.CITIES_FETCH, actions.CITIES_FETCH_SUCCESS, actions.CITIES_FETCH_FAIL],
	        promise: function promise(_ref3) {
	            var req = _ref3.req;
	            return req.get('/cities/' + cityQuery);
	        }
	    };
	}
	...
	function reverseGeocoding(params) {
	    ...
	    return {
	        types: [actions.REVERSE_GEOCODING_FETCH, actions.REVERSE_GEOCODING_FETCH_SUCCESS, actions.REVERSE_GEOCODING_FETCH_FAIL],
	        promise: function promise(_ref4) {
	            var req = _ref4.req;
	            return req.get('/cities/reverse-geocode', obj);
	        }
	    };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createLocalRouteDAO = void 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function fetchPublicUserProfile(params, loggedInUserId) {
	    params = params || {};
	
	    var uri = params.id ? '/users/' + params.id : '/users';
	
	    // if not id, probz search by username
	    var _params = params.id ? {} : { params: params };
	
	    return {
	        types: [types.PUBLIC_USER_FETCH, types.PUBLIC_USER_FETCH_SUCCESS, types.PUBLIC_USER_FETCH_FAIL],
	        promise: function promise(_ref) {
	            var req = _ref.req;
	            return req.get(uri, _params);
	        },
...
/***/ function(module, exports, __webpack_require__) {
	...
	function fetchUserRoutes(userId, params) {
	    if (!userId) {
	    ...
	    return {
	        ...
	        promise: function promise(_ref) {
	            var req = _ref.req;
	            return req.get('/routes/users/' + userId, { params: params });
	        }
	    };
	}
	    ...
	    var _ret = function () {
	        switch (action.type) {
	            ...
	            case types.CREATE_ROUTE_FETCH_SUCCESS:
	                ...
	                return {
	                    v: state.set('route', _Route2.default.mapper(action.payload)).set('isFetching', false).set('renderMapCounter', state.get('renderMapCounter') + 1).set('error', false)
	                };
	
	            case types.CREATE_ROUTE_FETCH_FAIL:
	
	                return {
	                    v: state.set('isFetching', false).set('error', action.error)
	                };
	
	            case types.ROUTE_CREATE_INIT:
	                return {
	                    v: state.set('route', new _Route2.default(action.route))
	                };
	
	            case types.CREATE_ROUTE_SET_TITLE:
	                return {
	                    v: state.setIn(['route', 'title'], action.text)
	                };
	
	            case types.CREATE_ROUTE_SET_ERRORS:
	                return {
	                    v: state.set('errors', action.errors)
	                };
	            ...
	            case types.POST_ROUTE_SUCCESS:
	                return {
	                    v: state.updateIn(['route'], function (route) {
	            ...
	            case types.CREATE_ROUTE_VERTICE_SPICES_FETCH:
	                return {
	                    v: state.set('fetchingSpices', true)
	                };
	
	            case types.CREATE_ROUTE_VERTICE_SPICES_FETCH_SUCCESS:
	                return {
	                    v: _Route2.default.updateVertice(state, _extends({}, action.payload)).set('fetchingSpices', false)
	                };
	
	            case types.CREATE_ROUTE_VERTICE_SPICES_FETCH_FAIL:
	                return {
	                    v: state.set('fetchingSpices', false).set('errors', 'Failed to fetch spices')
	                };
	            ...
	            case types.ADD_VERTICE_TO_ROUTE_SUCCESS:
	                ...
	                return {
	                    v: _Route2.default.updateVertice(state, vertData).set('pendingDoneActions', state.get('pendingDoneActions').pop()).set('renderMapCounter', state.get('renderMapCounter') + 1)
	                };
	            ...
	            case types.CREATE_ROUTE_VERTICE_DELETE:
	                ...
	                return {
	                    v: state.setIn(['route', 'vertices'], verts).set('renderMapCounter', state.get('renderMapCounter') + 1)
	                };
	
	            case types.ADD_VERTICE_TO_ROUTE_FAIL:
	                // TODO: reverse the vertice
	                return {
	                    v: state.set('failedToAddSpot', action.error)
	                };
	
	            case types.VERTICE_UPDATE_SUCCESS:
	                return {
	                    v: _Route2.default.updateVertice(state, action.meta)
	                };
	
	            // TODO: handle failure
	            case types.VERTICE_UPDATE_FAIL:
	                return {
	                    v: state.set('failedToUpdateSpot', action.error)
	                };
	
	            case types.CREATE_ROUTE_VERTICE_PHOTO_ADD:
	                return {
	                    v: state.set('uploadingPhoto', true).set('pendingDoneActions', state.get('pendingDoneActions').push(types.CREATE_ROUTE_VERTICE_PHOTO_ADD))
	                };
	
	            case types.CREATE_ROUTE_VERTICE_PHOTO_ADD_FAIL:
	                return {
	                    v: state.set('uploadingPhoto', false).set('pendingDoneActions', state.get('pendingDoneActions').pop())
	                };
	            ...
	            case types.CREATE_ROUTE_VERTICE_PHOTO_ADD_SUCCESS:
	                ...
	                return {
	                    v: _Route2.default.addVerticePhoto(state, vertice).set('uploadingPhoto', false).set('pendingDoneActions', state.get('pendingDoneActions').pop())
	                };
	
	            case types.CREATE_ROUTE_VERTICE_SPICE_PHOTO_ADD:
	                return {
	                    v: _Route2.default.addVerticePhoto(state, action.meta)
	                };
	
	            case types.CREATE_ROUTE_VERTICE_SPICE_PHOTO_REMOVE:
	                return {
	                    v: _Route2.default.removeVerticePhoto(state, action.meta)
	                };
	
	            case types.VERTICE_UPDATE_BUCKETS_SUCCESS:
	                return {
	                    v: _Route2.default.addVerticeTag(state, { bucket: action.payload, id: action.meta.id })
	                };
	
	            case types.VERTICE_DELETE_BUCKETS_SUCCESS:
	                return {
	                    v: _Route2.default.removeVerticeTag(state, { bucket: action.meta.bucketId, id: action.meta.id })
	                };
	            ...
	            case types.VERTICE_REORDER:
	                ...
	                return {
	                    v: state.set('route', route.set('vertices', (0, _immutable.List)(relocatedVertices))).set('renderMapCounter', state.get('renderMapCounter') + 1)
	                };
	
	            case types.ROUTE_FINISH:
	                return {
	                    v: state.set('donePressed', true)
	                };
	            case types.ROUTE_FINISH_SUCCESS:
	                return {
	                    v: state.set('finito', true)
	                };
	    ...
	    switch (action.type) {
	        ...
	        case types.VENUES_DIRECTIONS_MATRIX_FETCH_SUCCESS:
	            if (action.payload.data && action.payload.data.length) {
	                var newDirectionsResult = void 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function routes() {
	    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialRoutesState;
	    var action = arguments[1];
	...
	function reducer() {
	    ...
	    var _ret = function () {
	        ...
	        switch (action.type) {
	            ...
	            case actions.RECEIVE_ROUTES_FAILED:
	                return {
	                    v: state.merge(_defineProperty({}, _constants.DEFAULT_GRID_KEY, routes(state.get(_constants.DEFAULT_GRID_KEY), action)))
	                };
	            ...
	            case actions.ROUTES_QUERY_FAIL:
	                ...
	                return {
	                    v: state.merge((_state$merge2 = {}, _defineProperty(_state$merge2, key, routes(state.get(key), action)), _defineProperty(_state$merge2, 'terms', action.meta.terms), _state$merge2))
	                };
...
/***/ function(module, exports, __webpack_require__) {
	...
	function current() {
	    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialCurrentState;
	    var action = arguments[1];
	...
	function reducer() {
	    ...
	    switch (action.type) {
	        ...
	        case types.CITIES_CLEAR:
	            return state.set('cities', new _immutable.List());
	...
	function reducer() {
	    ...
	    switch (action.type) {
	        ...
	        case types.BOOKMARKS_FETCH:
	            return state.set('isFetching', true).set('fetched', false);
	...
	function reducer() {
	    ...
	    switch (action.type) {
	        ...
	        case types.PUBLIC_USER_FETCH_SUCCESS:
	            ...
	            var userData = (0, _get3.default)(action, 'payload._embedded.users[0]', (0, _get3.default)(action, 'payload', null));
	
	            if (action.payload._embedded) {
	
	                var user = new _User2.default(_User2.default.mapper(userData));
	                ...
	                return state.merge({
	                    user: new _User2.default(_User2.default.mapper(userData)),
	                    isFetching: false,
	                    isLoggedInUser: false,
	...
	function reducer() {
	    ...
	    switch (action.type) {
	        ...
	        case types.FETCH_USER_ROUTES_SUCCESS:
	            if (!(0, _get3.default)(action, 'payload._embedded')) {
	                return state;
	            }
	            return state.merge({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AnalyticsMiddleware2 = __webpack_require__(89);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var peoplePropsWhiteList = [types.SIGNUP_SUCCESS, types.LOGIN_SUCCESS, types.FACEBOOK_LOGIN_SUCCESS];
	...
	var AnalyticsMiddleware = function () {
	    ...
	    _createClass(AnalyticsMiddleware, [{
	        ...
	        value: function analyticsMiddleware() {
	            var _this = this;
	
	            return function (next) {
	                return function (action) {
	                    _this.addPeopleProps(action);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GooglePlacesAPIClient2 = __webpack_require__(34);
	
	var _GooglePlacesAPIClient3 = _interopRequireDefault(_GooglePlacesAPIClient2);
	
	var _reorderService2 = __webpack_require__(32);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _injectDependencies2 = __webpack_require__(92);
