...
/***/ function(module, exports, __webpack_require__) {
	...
	function updateProfile(userId, data) {
	    return {
	        ...
	        promise: function promise(_ref6) {
	            var req = _ref6.req;
	            return userService.updateProfile(userId, data, req);
	        }
	    };
	}
	...
	function reducer() {
	    ...
	    switch (action.type) {
	        ...
	        case types.USER_UPDATE_PROFILE_SUCCESS:
	            var updateUser = state.get('user').merge(action.payload);
	            var updatedUser = state.set('user', updateUser);
	            var updateSavingState = state.set('isSaving', false);
