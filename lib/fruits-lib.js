...
/***/ function(module, exports, __webpack_require__) {
	...
	var _middleware2 = __webpack_require__(111);
	...
	var _services2 = __webpack_require__(113);
	
	var _services = _interopRequireWildcard(_services2);
	
	var _utils2 = __webpack_require__(114);
	...
	var Vertice = function (_VerticeRecord) {
	    ...
	    _createClass(Vertice, null, [{
	        ...
	        value: function mapper(vertice) {
	            return new VerticeRecord(vertice).set('photos', new _immutable.List(vertice.photos)).set('venue', _Venue2.default.mapper(vertice.venue)).set('buckets', new _immutable.List(vertice.buckets));
	        }
	    }, {
	        key: 'oldToNewMapper',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _routesActions = __webpack_require__(16);
	
	var routes = _interopRequireWildcard(_routesActions);
	
	var _createVerticeAction = __webpack_require__(17);
	
	var createVertice = _interopRequireWildcard(_createVerticeAction);
	
	var _createRouteActions = __webpack_require__(18);
	
	var createRoute = _interopRequireWildcard(_createRouteActions);
	
	var _flashMessagesActions = __webpack_require__(23);
...
/***/ function(module, exports) {
	...
	var ROUTES_CREATE_TOGGLE_DRAFT = exports.ROUTES_CREATE_TOGGLE_DRAFT = 'ROUTES_CREATE_TOGGLE_DRAFT';
	var ROUTES_CREATE_TOGGLE_DRAFT_SUCCESS = exports.ROUTES_CREATE_TOGGLE_DRAFT_SUCCESS = 'ROUTES_CREATE_TOGGLE_DRAFT_SUCCESS';
	var ROUTES_CREATE_TOGGLE_DRAFT_FAIL = exports.ROUTES_CREATE_TOGGLE_DRAFT_FAIL = 'ROUTES_CREATE_TOGGLE_DRAFT_FAIL';
	
	var USER_ROUTE_MAKE_PUBLIC = exports.USER_ROUTE_MAKE_PUBLIC = 'USER_ROUTE_MAKE_PUBLIC';
	var USER_ROUTE_MAKE_PUBLIC_SUCCESS = exports.USER_ROUTE_MAKE_PUBLIC_SUCCESS = 'USER_ROUTE_MAKE_PUBLIC_SUCCESS';
	var USER_ROUTE_MAKE_PUBLIC_FAIL = exports.USER_ROUTE_MAKE_PUBLIC_FAIL = 'ROUTE_DETAIL_ROUTE_PUBLIC_FAIL';
	
	var USER_ROUTE_MAKE_PRIVATE = exports.USER_ROUTE_MAKE_PRIVATE = 'USER_ROUTE_MAKE_PRIVATE';
	var USER_ROUTE_MAKE_PRIVATE_SUCCESS = exports.USER_ROUTE_MAKE_PRIVATE_SUCCESS = 'USER_ROUTE_MAKE_PRIVATE_SUCCESS';
	var USER_ROUTE_MAKE_PRIVATE_FAIL = exports.USER_ROUTE_MAKE_PRIVATE_FAIL = 'USER_ROUTE_MAKE_PRIVATE_FAIL';
	
	var USER_DELETE_ROUTE = exports.USER_DELETE_ROUTE = 'USER_DELETE_ROUTE';
	var USER_DELETE_ROUTE_SUCCESS = exports.USER_DELETE_ROUTE_SUCCESS = 'USER_DELETE_ROUTE_SUCCESS';
	var USER_DELETE_ROUTE_FAIL = exports.USER_DELETE_ROUTE_FAIL = 'USER_DELETE_ROUTE_FAIL';
...
/***/ function(module, exports, __webpack_require__) {
	...
	function requestRoutes(bucketName, bucketId, city, offset) {
	...
	*/
	function fetchRoutesIfNeeded(routes, bucket, bucketId, city) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GooglePlacesAPIClient = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reorderService = __webpack_require__(19);
	...
	var _pollSpices = __webpack_require__(20);
	...
	function makeDraft(value, routeId) {
	    return {
	        types: [actions.ROUTES_CREATE_TOGGLE_DRAFT, actions.ROUTES_CREATE_TOGGLE_DRAFT_SUCCESS, actions.ROUTES_CREATE_TOGGLE_DRAFT_FAIL],
	        promise: function promise(_ref) {
	            var req = _ref.req;
	            return req.post('/routes/' + routeId + '/make-draft', { value: value });
	        }
	    };
	}
	...
	*/
	...
	function fetch(routeId) {
	    return {
	        ...
	        promise: function promise(_ref19) {
	            var req = _ref19.req;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.setRouteToPrivate = setRouteToPrivate;
	exports.setRouteToPublic = setRouteToPublic;
	...
	function deleteRoute(routeId) {
	    return {
	        types: [types.USER_DELETE_ROUTE, types.USER_DELETE_ROUTE_SUCCESS, types.USER_DELETE_ROUTE_FAIL],
	        promise: function promise(_ref8) {
	            var req = _ref8.req;
	            return req.delete('/routes/' + routeId);
	        },
	        meta: { routeId: routeId }
	    };
	}
	
	function setRouteToPrivate(routeId) {
	    return {
	        types: [types.USER_ROUTE_MAKE_PRIVATE, types.USER_ROUTE_MAKE_PRIVATE_SUCCESS, types.USER_ROUTE_MAKE_PRIVATE_FAIL],
	        promise: function promise(_ref9) {
	            var req = _ref9.req;
	            return req.post('/routes/' + routeId + '/make-private');
	        },
	        meta: { routeId: routeId }
	    };
	}
	
	function setRouteToPublic(routeId) {
	    return {
	        types: [types.USER_ROUTE_MAKE_PUBLIC, types.USER_ROUTE_MAKE_PUBLIC_SUCCESS, types.USER_ROUTE_MAKE_PUBLIC_FAIL],
	        promise: function promise(_ref10) {
	            var req = _ref10.req;
	            return req.post('/routes/' + routeId + '/make-public');
	        },
	        meta: { routeId: routeId }
	    };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.bookmarksReducer = exports.cityReducer = exports.notificationsReducer = exports.suggestions = exports.routeDetail = exports.userReducer = exports.selectedBucketReducer = exports.routesReducer = exports.flashMessagesReducer = exports.createVerticeReducer = exports.createRouteReducer = exports.appReducer = undefined;
	...
	function reducer() {
	    ...
	    switch (action.type) {
	        ...
	        case types.ROUTES_CREATE_TOGGLE_DRAFT:
	            return state.set('draft', (0, _immutable.fromJS)({
	                posting: true,
	                error: false
	            }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isEqual2 = __webpack_require__(36);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function reducer() {
	    ...
	    switch (action.type) {
	        ...
	        case actions.REQUEST_ROUTES:
	        case actions.RECEIVE_ROUTES_FAILED:
	            return state.merge(_defineProperty({}, action.meta.bucketName, routes(state.get(action.meta.bucketName), action)));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxStorage = __webpack_require__(64);
	    ...
	    switch (action.type) {
	        ...
	        case types.FACEBOOK_LOGIN_FAIL:
	            return state.merge({
	                ...
	                user: null,
	                token: null,
	                authError: action.error ? action.error.message : action.payload.errorMessage
	            });
	        ...
	        case types.USER_UPDATE_PROFILE_SUCCESS:
	            return state.set('user', (0, _immutable.Map)(action.payload)).set('isSaving', false);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createLoader = __webpack_require__(65);
	...
	var _createMiddleware = __webpack_require__(80);
	...
	var _decorators2 = __webpack_require__(100);
	...
	exports.default = _extends({}, __webpack_require__(79), {
	    createLoader: __webpack_require__(65)['default'],
	    createMiddleware: __webpack_require__(80)['default'],
	    decorators: __webpack_require__(100),
	    reducer: __webpack_require__(81)['default']
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxActions = __webpack_require__(67);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createAction = __webpack_require__(68);
	
	var _createAction2 = _interopRequireDefault(_createAction);
	
	var _handleAction = __webpack_require__(69);
	
	var _handleAction2 = _interopRequireDefault(_handleAction);
	
	var _handleActions = __webpack_require__(76);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ownKeys = __webpack_require__(77);
	
	var _ownKeys2 = _interopRequireDefault(_ownKeys);
	
	var _reduceReducers = __webpack_require__(78);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodash3 = __webpack_require__(83);
	...
	var _lodash7 = __webpack_require__(84);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var bindCallback = __webpack_require__(88),
	    ...
	    restParam = __webpack_require__(90);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _immutablejs = __webpack_require__(105);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodash3 = __webpack_require__(82);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Available under MIT license <https://lodash.com/license>
	 */
	var toPath = __webpack_require__(104),
	    isArray = __webpack_require__(75);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _City = __webpack_require__(109);
	...
	function reducer() {
	    ...
	    switch (action.type) {
	        case types.BOOKMARKS_POST:
	            var items = state.get('items').push((0, _immutable.Map)({ id: action.bookmark.routeId }));
	        ...
	        case types.BOOKMARKS_FETCH_SUCCESS:
	            return state.merge({
	                ...
	                fetched: true,
	                fetchedDeep: true,
	                items: (0, _immutable.List)(action.payload.map(_Route2.default.mapper))
	            });
	        ...
	        case types.BOOKMARKS_DELETE:
	            return state.set('items', removeBookmark(state, action.bookmark.routeId));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AnalyticsMiddleware2 = __webpack_require__(112);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GooglePlacesAPIClient2 = __webpack_require__(21);
	
	var _GooglePlacesAPIClient3 = _interopRequireDefault(_GooglePlacesAPIClient2);
	
	var _reorderService2 = __webpack_require__(19);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _injectDependencies2 = __webpack_require__(115);
