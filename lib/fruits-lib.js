...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	function queryRoutes(terms, offset, limit, city, sort) {
	    var params = {
	        terms: terms, offset: offset, limit: limit, city: city, sort: sort
	    };
	    return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createKey(action) {
	    var city = action.meta.city || _constants.DEFAULT_CITY;
	    var terms = action.meta.terms;
	    if (Array.isArray(terms)) {
	        terms = terms.join(':');
	    }
	
	    terms = terms || _constants.DEFAULT_TERMS;
