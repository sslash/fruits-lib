...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utils2 = __webpack_require__(89);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Venue = function (_VenueRecord) {
	    ...
	    _createClass(Venue, [{
	        ...
	        key: 'foursquareDetailToVenue',
	        value: function foursquareDetailToVenue(venue) {}
	    }, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function gatherMeta(data) {
	    var _data$foursquare$meta = data.foursquare.meta;
	    var price = _data$foursquare$meta.price;
	    var hours = _data$foursquare$meta.hours;
	...
	function gatherReviews(data) {
	    return data.foursquare.tips.map(function (tips) {
	...
	function current() {
	    ...
	    switch (action.type) {
	        ...
	        case actions.SUGGESTIONS_DETAIL_FETCH_SUCCESS:
	            return state.set('isFetching', false).setIn(['item', 'images'], (0, _immutable.fromJS)(gatherImages(action.payload))).setIn(['item', 'reviews'], (0, _immutable.fromJS)(gatherReviews(action.payload))).setIn(['item', 'ratings'], (0, _immutable.fromJS)(gatherRatings(action.payload))).setIn(['item', 'meta'], (0, _immutable.fromJS)(gatherMeta(action.payload)));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _City = __webpack_require__(85);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _injectDependencies2 = __webpack_require__(90);
