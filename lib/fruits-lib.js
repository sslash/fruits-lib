	...
	var Vertice = function (_VerticeRecord) {
	    ...
	    _createClass(Vertice, null, [{
	        ...
	        value: function mapper(vertice) {
	            return new VerticeRecord(vertice).set('photos', new _immutable.List(vertice.photos)).set('venue', new _Venue2.default(vertice.venue));
	        }
	    }, {
	        key: 'oldToNewMapper',
...
/***/ function(module, exports, __webpack_require__) {
	...
	function fetchDistanceMatrix(routeId, travelmode) {
	    return {
	        ...
	        promise: function promise(_ref3) {
	            var req = _ref3.req;
	            return req.get('/routes/' + routeId + '/directionsMatrix', { params: { travelmode: travelmode } });
	        }
	    };
	}
	
	function fetchDistanceMatrixBetweenVenues(directionsResult, travelmode, index, routeId) {
	    var venueIds = [];
	    ...
	    return {
	        ...
	        promise: function promise(_ref4) {
	            var req = _ref4.req;
	            return req.get('/routes/' + routeId + '/directionsMatrix', { params: { travelmode: travelmode, venueIds: venueIds } });
	        }
	    };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function mapNewDirections(newDirections, oldDirections) {
	    return oldDirections.map(function (route) {
	        if (isRoute(route) && (0, _isEqual3.default)(route.get('geocoded_waypoints').toJS(), newDirections.data[0].geocoded_waypoints)) {
	            return (0, _immutable.fromJS)(newDirections.data[0]);
	        } else {
	            return route;
	        }
	    });
