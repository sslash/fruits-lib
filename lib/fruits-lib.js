	...
	var Route = function (_RouteRecord) {
	    ...
	    _createClass(Route, [{
	        ...
	        value: function addVerticeTag(routeState, vertice) {
	            return Route.doUpdate(routeState, vertice, function (verts, index) {
	                return verts.update(index, function (vert) {
	                    return vert.set('tags', (0, _immutable.List)(vertice.tags));
	                });
	            });
	        }
	    }, {
	...
	var Vertice = function (_VerticeRecord) {
	    ...
	    _createClass(Vertice, null, [{
	        ...
	        value: function mapper(vertice) {
	            return new VerticeRecord(vertice).set('photos', new _immutable.List(vertice.photos)).set('venue', _Venue2.default.mapper(vertice.venue));
	        }
	    }, {
	        key: 'oldToNewMapper',
	    ...
	    _createClass(Venue, [{
	        ...
	        value: function foursquareToVenue(venue) {
	            ...
	            return {
	                ...
	                ratingBase: '10',
	                geometry: Venue.mapSpicesGeo(venue.getIn(['venue', 'location', 'lat']), venue.getIn(['venue', 'location', 'lng'])),
...
/***/ function(module, exports) {
	...
	var VERTICE_UPDATE_TAGS = exports.VERTICE_UPDATE_TAGS = 'VERTICE_UPDATE_TAGS';
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.updateVerticeTags = updateVerticeTags;
	...
	function updateVerticeTags(vertice) {
	...
	*/
	...
	// copied from routeDetail
	function fetch(routeId, progress) {
	    return {
	        ...
	        promise: function promise(_ref16) {
	            var req = _ref16.req;
	            return req.get('/routes/' + routeId + '?edit=true', { progress: progress });
	        },
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.determineGeoType = determineGeoType;
	exports.fetchSpicesForVertice = fetchSpicesForVertice;
	...
	function fetchDistanceMatrixBetweenVenues(firstSpot, secondSpot, travelmode, routeId, index) {
	    var venues = determineGeoType([firstSpot, secondSpot]);
	    var params = {
	...
	function determineGeoType(venues) {
	    return venues.map(function (venue) {
	        var geo = venue.get('geometry') || {};
	...
	function reducer() {
	    ...
	    switch (action.type) {
	        ...
	        case types.VERTICE_UPDATE_TAGS:
	            return _Route2.default.addVerticeTag(state, action.payload);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function updateIndex(newData, oldData, index) {
	    return oldData.set(index, (0, _immutable.fromJS)(newData.data[0]));
	}
	module.exports = exports['default'];
