...
/***/ function(module, exports, __webpack_require__) {
	...
	var _middleware2 = __webpack_require__(74);
	
	var _middleware = _interopRequireWildcard(_middleware2);
	
	var _services2 = __webpack_require__(76);
	
	var _services = _interopRequireWildcard(_services2);
	
	var _utils2 = __webpack_require__(77);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _publicUserProfileActions = __webpack_require__(81);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _City = __webpack_require__(71);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AnalyticsMiddleware2 = __webpack_require__(75);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _injectDependencies2 = __webpack_require__(78);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function reducer() {
	    ...
	    switch (action.type) {
	        ...
	        case types.USER_UPDATE_PROFILE_SUCCESS:
	            return state.merge({
	                user: new _User2.default(action.payload),
	                isFetching: false,
	                error: null
	            });
	        ...
	        case types.BOOKMARKS_FETCH_SUCCESS:
	            ...
	            return state.merge({
	                bookmarkedRoutes: bookmarks ? (0, _immutable.List)(bookmarks.map(_Route2.default.mapper)) : []
	            });
	...
	var User = function (_UserRecord) {
	    ...
	    _createClass(User, [{
	        ...
	        value: function getProfilePhoto() {
	            return this.get('profile') ? this.getIn(['profile', 'picture']) : this.get('image');
	        }
	    }], [{
	        key: 'mapper',
