...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducers2 = __webpack_require__(34);
	
	var _reducers = _interopRequireWildcard(_reducers2);
	
	var _middleware2 = __webpack_require__(72);
	
	var _middleware = _interopRequireWildcard(_middleware2);
	
	var _services2 = __webpack_require__(74);
	...
	var _actionTypes2 = __webpack_require__(15);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createVerticeAction = __webpack_require__(18);
	
	var createVertice = _interopRequireWildcard(_createVerticeAction);
	
	var _createRouteActions = __webpack_require__(19);
	
	var createRoute = _interopRequireWildcard(_createRouteActions);
	
	var _flashMessagesActions = __webpack_require__(24);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	function queryRoutes(terms, offset, limit, city) {
	    var params = {
	        terms: terms, offset: offset, limit: limit, city: city
	    };
	    return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GooglePlacesAPIClient = __webpack_require__(22);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reorderService = __webpack_require__(20);
	...
	var _pollSpices = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _appReducer2 = __webpack_require__(35);
	
	var _appReducer3 = _interopRequireDefault(_appReducer2);
	
	var _createRouteReducer2 = __webpack_require__(36);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isEqual2 = __webpack_require__(38);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createKey(action) {
	    var terms = action.meta.terms;
	    if (Array.isArray(terms)) {
	        terms = terms.join(':');
	    }
	    return (action.meta.city || _constants.DEFAULT_CITY) + ':' + (terms || _constants.DEFAULT_TERMS);
	}
	...
	function reducer() {
	    ...
	    switch (action.type) {
	        ...
	        case actions.ROUTES_QUERY_FAIL:
	            ...
	            return state.merge(_defineProperty({}, key, routes(state.get(key), action)));
	...
	function reducer() {
	    ...
	    switch (action.type) {
	        ...
	        case LOAD:
	            ...
	            return state.set('user', (0, _immutable.fromJS)(user.user)).set('routes', user.routes).set('token', user.token);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AnalyticsMiddleware2 = __webpack_require__(73);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GooglePlacesAPIClient2 = __webpack_require__(22);
	
	var _GooglePlacesAPIClient3 = _interopRequireDefault(_GooglePlacesAPIClient2);
	
	var _reorderService2 = __webpack_require__(20);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _injectDependencies2 = __webpack_require__(76);
